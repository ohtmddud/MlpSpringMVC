...
<body>
	<!-- top에 보여질 메뉴 -->
	<div >
		<form name="login_frm" action="/stswebTest/emp/login.do" method="post">
			<table cellpadding="0" cellspacing=5 width="750" bgcolor=#f3f3f3
				border=0>
				<tr>
																...
																<tr>
																	<td>
																		<table cellpadding="0" cellspacing="0" border=0>
																			...
																			<tr>
																				<td colspan=3><img
																					src="/stswebTest/resources/images/page_login.gif"></td>
																			</tr>
																			<tr>
																				<td height=25></td>
																			</tr>
																			<tr>
																				<td
																					background="/stswebTest/resources/images/inputBg.gif"><img
																					src="/stswebTest/resources/images/login_id.gif"></td>
																				<td
																					background="/stswebTest/resources/images/inputBg.gif"><input
																				...
																				<td rowspan=3 style="padding-left: 10" valign=bottom>
																					<input type='image'
																					src="/stswebTest/resources/images/btn_login.gif"
																					border="0" tabindex=3>
																				</td>
																			</tr>
																			<tr>
																			...
																			<tr>
																				<td
																					background="/stswebTest/resources/images/inputBg.gif"><img
																					src="/stswebTest/resources/images/login_pass.gif"></td>
																				<td
																					background="/stswebTest/resources/images/inputBg.gif"><input
